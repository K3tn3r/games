...
class ActorEvents_77 extends ActorScript
{
	...
	override public function init()
	{
		...
		/* ======================== When Creating ========================= */
		if(!(Engine.engine.getGameAttribute("left")))
		{
		...
		else if(Engine.engine.getGameAttribute("left"))
		{
			Engine.engine.setGameAttribute("N of Bullet", (Engine.engine.getGameAttribute("N of Bullet") + 1));
		...
		addCollisionListener(actor, function(event:Collision, list:Array<Dynamic>):Void
		{
			...
			{
				shoutToScene("_customEvent_" + "Blobdeath");
				recycleActor(actor);
				Engine.engine.setGameAttribute("N of Bullet", (Engine.engine.getGameAttribute("N of Bullet") - 1));
		...
		addCollisionListener(actor, function(event:Collision, list:Array<Dynamic>):Void
		{
			...
			{
				shoutToScene("_customEvent_" + "sh0t");
				recycleActor(actor);
				Engine.engine.setGameAttribute("N of Bullet", (Engine.engine.getGameAttribute("N of Bullet") - 1));
			}
		});
		...
		addCollisionListener(actor, function(event:Collision, list:Array<Dynamic>):Void
		{
			...
			{
				shoutToScene("_customEvent_" + "killBoofer");
				recycleActor(actor);
				Engine.engine.setGameAttribute("N of Bullet", (Engine.engine.getGameAttribute("N of Bullet") - 1));
		...
		addCollisionListener(actor, function(event:Collision, list:Array<Dynamic>):Void
		{
			...
			{
				shoutToScene("_customEvent_" + "shot");
				recycleActor(actor);
				Engine.engine.setGameAttribute("N of Bullet", (Engine.engine.getGameAttribute("N of Bullet") - 1));
			}
		});
