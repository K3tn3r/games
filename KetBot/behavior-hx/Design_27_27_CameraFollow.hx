...
class Design_27_27_CameraFollow extends ActorScript
{
	...
	override public function init()
	{
		...
		/* ======================== When Creating ========================= */
		_intendedCameraX = asNumber(Engine.engine.getGameAttribute("Spawn X"));
		propertyChanged("_intendedCameraX", _intendedCameraX);
		_intendedCameraY = asNumber(Engine.engine.getGameAttribute("Spawn Y"));
		propertyChanged("_intendedCameraY", _intendedCameraY);
		_currentCameraX = asNumber(Engine.engine.getGameAttribute("Spawn X"));
		propertyChanged("_currentCameraX", _currentCameraX);
		_currentCameraY = asNumber(Engine.engine.getGameAttribute("Spawn Y"));
