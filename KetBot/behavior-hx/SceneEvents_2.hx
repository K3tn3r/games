...
class SceneEvents_2 extends SceneScript
{
	...
	override public function init()
	{
		...
		/* ======================== When Creating ========================= */
		Engine.engine.setGameAttribute("Time", 180);
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				g.drawString("" + "SCORE", 32, 40);
				g.drawString("" + Engine.engine.getGameAttribute("score"), 100, 40);
				g.drawString("" + "LIFE", 284, 40);
				g.drawString("" + Engine.engine.getGameAttribute("Lives"), 340, 40);
